...
generateRuntime _ =
    String.join "\n"
        ...
        , "    /* Simple implementation - allocate buffer and print */"
        , "    char *buf = malloc(4096);"
        , "    int len = 0;"
        , "    switch (value.tag) {"
        , "        case 0: len = snprintf(buf, 4096, \"%ld\", (long)value.data.i); break;"
        , "        case 1: len = snprintf(buf, 4096, \"%g\", value.data.f); break;"
        , "        case 2: len = snprintf(buf, 4096, \"\\\"%s\\\"\", value.data.s); break;"
        , "        case 3: len = snprintf(buf, 4096, \"'%c'\", (char)value.data.i); break;"
        , "        case 4: strcpy(buf, \"False\"); break;"
        , "        case 5: strcpy(buf, \"True\"); break;"
        , "        case 6: strcpy(buf, \"()\"); break;"
        , "        default: snprintf(buf, 4096, \"<value:%d>\", value.tag); break;"
        , "    }"
        , "    return elm_string(buf);"
        , "}"
        ]
